...
$.getJSON("https://www.eventbrite.com/venue/api/feeds/venue/426.json", function(data) {
    ...
    $.each(data, function(key, val) {
        ...
        if (val.poster !== null) {
            ...
            output += '<a data-fancybox href="/s/petes.jpg"><img src="pb.jpg" /></a></div>';
        }
